...
export default {
  ...
  config: {
    ...
    agent: {
      type: "string",
      "default": "Clippy",
      "enum": ["Octocat", "Clippy", "Bonzi", "F1", "Genie", "Genius", "Links", "Merlin", "Peedy", "Rocky", "Rover"]
    }
  },
  ...
  activate() {
    ...
    atom.workspace.observeTextEditors(function() {
      ...
      for (var i = 0; i < textEditors.length; i++) {
        ...
        textEditors[i].getBuffer().onDidDestroy(function () {
            console.log("deleted");
